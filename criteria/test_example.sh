...
#python attack_evaluate.py  -dataset cifar  -model vgg16 -attack CW
#python attack_evaluate.py  -dataset cifar  -model vgg16 -attack PGD
##
#python attack_evaluate.py  -dataset cifar  -model resnet20 -attack CW
#python attack_evaluate.py  -dataset cifar  -model resnet20 -attack PGD
...
#
#python coverage.py  -dataset cifar  -model vgg16 -attack CW  -layer 55
#python coverage.py  -dataset cifar  -model vgg16 -attack PGD -layer 55

#python coverage.py  -dataset cifar  -model resnet20 -attack CW -layer 70
#python coverage.py  -dataset cifar  -model resnet20 -attack PGD -layer 70
#
...
#python attack_evaluate.py  -dataset cifar  -model adv_vgg16 -attack CW
#python attack_evaluate.py  -dataset cifar  -model adv_vgg16 -attack PGD
##
#python attack_evaluate.py  -dataset cifar  -model adv_resnet20 -attack CW
#python attack_evaluate.py  -dataset cifar  -model adv_resnet20 -attack PGD
...
python coverage.py  -dataset cifar  -model adv_vgg16 -attack CW  -layer 55
python coverage.py  -dataset cifar  -model adv_vgg16 -attack PGD -layer 55

#python coverage.py  -dataset cifar  -model adv_resnet20 -attack CW -layer 70
#python coverage.py  -dataset cifar  -model adv_resnet20 -attack PGD -layer 70
